...
### 1.12. Gói quản lý sản phẩm

<img src="img/UC_QuanLySanPham.png">

|          Tiêu đề           | Nội dung                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| :------------------------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|      **Tên UseCase**       | **Thêm, sửa, xoá sản phẩm**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|     **Tác nhân chính**     | Nhân viên, Người quản trị                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|          **Mức**           | 3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **Người chịu trách nhiệm** | Nhân viên                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|     **Tiền điểu kiện**     | 1. Nhân viên cần truy cập thành công vào hệ thống<br />2. Nếu  sửa hoặc xoá thì sản phẩm phải tồn tại trong CSDL                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|   **Đảm bảo tối thiếu**    | Không có dữ liệu sai và kết nối CSDL                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|   **Đảm bảo thành công**   | 1. Với Thêm thì phải thêm thành công và hiển thị ra màn hình<br />2. Với Sửa thì phải cho phép sửa và Cập nhật lại thành công<br />3. Với Xoá thì phải xoá thành công  sản phẩm                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|       **Kích hoạt**        | Khi nhân viên hay người quản trị  truy cập vào quản lý sản phẩm                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|     **Chuỗi sự kiện**      | 1. Nhân viên chọn chức năng  " Quản  lý sản phẩm"<br />2. hệ thống hiển thị thông tin các sản phẩm đã có<br />3. Nhân viên chọn chức năng  " thêm  sản phẩm"<br />3.1. Hệ thống hiển thị giao diện nhập liệu<br />3.2 Nhân viên nhập thông tin sản phẩm  muốn thêm<br />3.3. Nhân viên nhấn Tạo<br />3.4. Hệ thống thông báo thành công<br />4. Nhân viên chọn chức năng " Sửa sản phẩm "<br />4.1 Hệ thống hiển thị giao diện nhập liệu<br />4.2 Nhân viên sửa thông tin sản phẩm muốn sửa<br />4.3 Nhân viên nhấn Cập nhật<br />5. Nhân viên chọn chức năng " Xoá sản phẩm "<br />5.1 Hệ thống hiển thị thông báo " Bạn muốn xoá sản phẩm không "<br />5.2 Nhân viên chọn một trong hai lựa chọn ( Xoá và Huỷ ) |
|        **Ngoại lệ**        | **3.a. Nhân viên nhập sai định dạng**<br />3.a.1. Hệ thống báo lỗi định dạng<br />3.a.2. Nhân viên kiểm tra lại dữ liệu đã nhập<br />3.a.3. Quay lại bước 3,4,5                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |

|          Tiêu đề           | Nội dung                                                                                                                                                                                                       |
| :------------------------: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|      **Tên UseCase**       | **Phân loại theo danh mục**                                                                                                                                                                                    |
|     **Tác nhân chính**     | Nhân viên, Người quản trị                                                                                                                                                                                      |
|          **Mức**           | 3                                                                                                                                                                                                              |
| **Người chịu trách nhiệm** | Nhân viên                                                                                                                                                                                                      |
|     **Tiền điểu kiện**     | 1. Nhân viên cần truy cập thành công vào hệ thống                                                                                                                                                              |
|   **Đảm bảo tối thiếu**    | Không có dữ liệu sai và kết nối CSDL                                                                                                                                                                           |
|   **Đảm bảo thành công**   | Tìm thấy các sản phẩm thành công theo danh mục                                                                                                                                                                 |
|       **Kích hoạt**        | Khi nhân viên hay người quản trị  truy cập vào quản lý sản phẩm                                                                                                                                                |
|     **Chuỗi sự kiện**      | 1. Nhân viên chọn chức năng  " Phân loại danh mục"<br />2. hệ thống hiển thị thông tin các sản phẩm đã có<br />3. Nhân viên chọn các loại danh mục để tìm kiếm <br />4. Hệ thống trả  về dữ liệu theo danh mục |
|        **Ngoại lệ**        | không có ngoại lệ                                                                                                                                                                                              |

|          Tiêu đề           | Nội dung                                                                                                                                                                                                                                                                          |
| :------------------------: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|      **Tên UseCase**       | **Tình trạng sản phẩm**                                                                                                                                                                                                                                                           |
|     **Tác nhân chính**     | Nhân viên, Người quản trị                                                                                                                                                                                                                                                         |
|          **Mức**           | 3                                                                                                                                                                                                                                                                                 |
| **Người chịu trách nhiệm** | Nhân viên                                                                                                                                                                                                                                                                         |
|     **Tiền điểu kiện**     | Nhân viên cần truy cập thành công vào hệ thống                                                                                                                                                                                                                                    |
|   **Đảm bảo tối thiếu**    | Không có dữ liệu sai và kết nối CSDL                                                                                                                                                                                                                                              |
|   **Đảm bảo thành công**   | HIển thị thành công tình trạng sản phẩm được chỉ định                                                                                                                                                                                                                             |
|       **Kích hoạt**        | Khi nhân viên hay người quản trị  truy cập vào quản lý sản phẩm                                                                                                                                                                                                                   |
...
- **[Hợp lệ]**
  ...
  -Tính **lãi/lỗ = Doanh thu – Chi phí** _(Self-Message)_
...
### 2.8 Biểu đồ tuần tự sản phẩm:

#### 2.8.1 Biểu đồ tuần tự thêm sản phẩm:

<img src="img/SE_ThemSanPham.png">

#### 2.8.2 Biểu đồ tuần tự sửa sản phẩm

<img src="img/SE_SuaSanPham.png">

#### 2.8.3 Biểu đồ tuần tự xoá sản phẩm:

<img src="img/SE_XoaSanPham.png">
...
Sau khi hoàn thành quá trình phân tích nghiệp vụ và áp dụng UML để phân tích, thiết kế chi tiết các sơ đồ quan trọng ( UseCase, Sequence, Class ), báo cáo mà nhóm 3 làm đã xây dựng được một bộ tài liệu thiết kế hệ thống cho " Ứng dụng Quản lý Tạp Hoá". Phần này dùng để tổng kết lại các kết quả đã đạt được, đưa ra các đánh giá về ưu điểm và nhược điểm của bản thiết kế và đề xuất các hướng phát triển trong tương lai

### 4.1 Tổng kết các kết quả đạt được:

Báo cáo đã thành công trong việc chuyển hoá các cầu nghiệp vụ của một tạp hoá thành một mô hình thiết kế hướng đối tượng chi tiết. Các kết quả chích bao gồm:

    **1. Bộ tài liệu đặc tả yêu cầu:** Đã thiết kế và mô tả chi tiết các quy trình nghiệp vụ phức tạp và đặt thù của bài toán  Quản lý tạp hoá.

    2. Bộ tài liệu thiết kế UML:

    - Phân tích Use Case: Xây dựng thành công 7 Gói Use Case chính, bao phủ toàn diện các chức năng trong hệ thống:

### 4.2 Đánh gia ưu điểm và nhược điểm:
